...
-(IBAction) connectButtonWasClicked: (id) sender
{
    VPNConnection * connection = [self selectedConnection];
    if (  connection  ) {
        [connection addToLog: @"AxionVPN: Disconnecting; VPN Details… window connect button pressed"];
...
-(IBAction) disconnectButtonWasClicked: (id) sender
{
    ...
    VPNConnection * connection = [self selectedConnection];
    if (  connection  ) {
        [connection addToLog: @"AxionVPN: Disconnecting; VPN Details… window disconnect button pressed"];
