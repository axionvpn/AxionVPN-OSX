...
@interface VPNConnection : TBPerformer <NSWindowDelegate>
{
    ...
    //      AxionVPN.app/Contents/Resources/Deploy
    ...
    NSString *acctType;                     //Axion Account Type
    NSString *remoteIP;                     //Axion Remote IP from get-conf call
...
-(void)             connectNoChecks:                    (id)                sender
                  userKnows:                    (BOOL)              userKnows;
