...
@interface MenuController : NSObject <NSAnimationDelegate,NSMenuDelegate>
{
    ...
    NSMenuItem              * vpnDetailsItem;               //    "Settings" item for menu
    NSMenuItem              * axionNetworksItem;            //    Axion Networks

    
    NSMenuItem              * quitItem;                     // "Quit AxionVPN" item for menu
    ...
    MyPrefsWindowController * logScreen;                    // Log window ("Settings" window)
...
@property (strong) AxionNetworkSelect *AxionWindow;
@property (strong) NSWindow *AxionNetworkWindow;

//AxionVPN - Added functions
