...
# launch AxionVPN if the 'launchAtNextLogin' preference is "1" or OpenVPN is running.
#
# The preference is set to "1" when you launch AxionVPN and is set to "0" when you
# Quit AxionVPN and you are not logging out.
...
if [ "${launch_at_login_preference}" = "1" ] ; then
  open /Applications/AxionVPN.app
fi
