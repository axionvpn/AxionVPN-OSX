            ...
            TBShowAlertWindow(NSLocalizedString(@"Warning", @"Window title"),
							  [NSString stringWithFormat:
							   NSLocalizedString(@"Tunnelblick was unable to save its preferences because OS X refused to save them.\n\n"
												 ...
												 @"%@/Library/Preferences/com.AxionVPN.AxionVPN.plist.\n\n"
                                                 @"If they are corrupt, the preferences will be automatically cleared the next time you launch AxionVPN (after making a backup of them).", @"Window text"), NSHomeDirectory()]);
        } else {
