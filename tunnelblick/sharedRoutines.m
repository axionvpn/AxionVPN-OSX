...
NSString * fileIsReasonableSize(NSString * path) {
    ...
    if (  ! path  ) {
        return [NSString stringWithFormat: NSLocalizedString(@"An Internal AxionVPN error occurred%@%@", @"Window text"),
...
NSString * fileIsReasonableAt(NSString * path) {
    ...
    if (  ! path  ) {
        NSString * errMsg = [NSString stringWithFormat: NSLocalizedString(@"An Internal AxionVPN error occurred%@%@", @"Window text"),
