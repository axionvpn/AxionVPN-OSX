...
#define L_AS_T_LOGS   @"/Library/Application Support/AxionVPN/Logs"

#define L_AS_T_SHARED @"/Library/Application Support/AxionVPN/Shared"
#define L_AS_T_USERS  @"/Library/Application Support/AxionVPN/Users"

#define L_AS_T_TBLKS  @"/Library/Application Support/AxionVPN/Tblks"
...
#define INSTALLER_LOG_PATH      @"/tmp/AxionVPN-installer-log.txt"
...
#define TUNNELBLICKD_LOG_FOLDER @"/var/log/AxionVPN"
#define TUNNELBLICKD_LOG_PATH_C "/var/log/AxionVPN/tunnelblickd.log"
#define TUNNELBLICKD_PREVIOUS_LOG_PATH_C "/var/log/AxionVPN/tunnelblickd.previous.log"
...
//#define PERMS_SECURED_FOLDER     0777
...
//*************************************************************************************************
// Bit masks for bitMask parameter of openvpnstart's start sub-commands
