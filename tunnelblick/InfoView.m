...
-(void) awakeFromNib
{
    ...
    if (  htmlFromFile  ) {
		...
		NSString * localizedContent = NSLocalizedString(@" %5$@, software for access to the AxionVPN Network.\n\nAxionVPN is based on %1$@ which is free software: you can redistribute it and/or modify it under the terms of the %2$@ as published by the %3$@.\n\n%4$@ is a registered trademark of OpenVPN Technologies, Inc.", @"Window text");
        ...
        [self replaceString: @"%5$@"
                 withString: @"AxionVPN"
                  urlString: @"https://axionvpn.com/"
                         in: descriptionString];
