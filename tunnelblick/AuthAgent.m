...
-(NSString *) passwordFromKeychain {
    ...
    if (  [self passwordIsInKeychain]  ) {
        return [passphraseKeychain password];
    }
    return nil;
}
...
-(void)saveUsername:(NSString *)usernameLocal andPassword:(NSString *)passwordLocal
{
...
-(NSArray *)getUsernameAndPassword
{
    ...
    if (  [passwordLocal length] == 0  ) {
        ...
        */
        ...
        if (   [loginScreen isSaveCredsInKeychainChecked]  ) {
